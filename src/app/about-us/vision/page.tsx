...
import { Target, Lightbulb, Compass, Palette, User, Briefcase } from 'lucide-react';
      ...
      <main>
        ...
        <section className="relative py-24 md:py-32 bg-[#FCF9F4] overflow-hidden">
          ...
          <div className="relative z-10 max-w-screen-xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-slate-500 font-medium">
              The Foundation of Jayotri Academy
            </p>
          </div>
        </section>
        ...
        <section className="py-20 max-w-screen-xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
            {/* Vision Card */}
            <div className="bg-primary p-12 rounded-3xl text-white relative overflow-hidden group">
          ...
          <div className="max-w-screen-xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {pillars.map((pillar, index) => (
                ...
                >
                  <div className="w-16 h-16 bg-[#00b2a9]/10 rounded-2xl flex items-center justify-center mb-6">
                    {pillar.icon}
                  </div>
